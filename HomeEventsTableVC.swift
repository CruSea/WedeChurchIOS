...
class HomeEventsTableVC: UITableViewController {
    ...
    var homeEventsListNames: [String] = [String]()
    var homeEventsListImages: [String] = [String]()

    
    override func viewDidLoad() {
        super.viewDidLoad()

        self.homeEventsListImages = ["church","mekane","yougo","church","mekane","yougo","church","mekane","yougo", "church","mekane","yougo","church","mekane","yougo","church","mekane","yougo","church","mekane","yougo", "church","mekane","yougo"]
        self.homeEventsListNames  = [
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return homeEventsListNames.count
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.homeEventName.text = homeEventsListNames[indexPath.row]
        cell.homeEventImage.image = UIImage(named: homeEventsListImages[indexPath.row])
